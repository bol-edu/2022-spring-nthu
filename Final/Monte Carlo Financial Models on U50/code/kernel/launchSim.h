...
#pragma HLS function_instantiate variable=rng0
#pragma HLS DATAFLOW
...
#pragma HLS STREAM variable=s_num0 depth=4
#pragma HLS STREAM variable=s_num1 depth=4
//#pragma HLS INTERFACE axis port=s_num0
//#pragma HLS INTERFACE axis port=s_num1
...
#pragma HLS STREAM variable=sRNG0 depth=4
#pragma HLS STREAM variable=sRNG1 depth=4
//#pragma HLS INTERFACE axis port=sRNG0
//#pragma HLS INTERFACE axis port=sRNG1
