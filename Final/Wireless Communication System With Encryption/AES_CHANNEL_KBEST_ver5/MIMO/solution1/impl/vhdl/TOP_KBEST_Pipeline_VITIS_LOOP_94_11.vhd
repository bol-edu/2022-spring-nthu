...
attribute shreg_extract : string;
    ...
    signal i_35_cast_fu_209_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal ap_sig_allocacmp_i_27 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_39_fu_225_p10 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_40_fu_248_p10 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    mux_84_32_1_1_U1192 : component TOP_mux_84_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    mux_84_32_1_1_U1193 : component TOP_mux_84_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    add_ln94_fu_203_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_27) + unsigned(ap_const_lv4_1));
    ...
    ap_sig_allocacmp_i_27_assign_proc : process(ap_CS_fsm_state1, i_fu_64, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_i_27 <= ap_const_lv4_0;
        else 
            ap_sig_allocacmp_i_27 <= i_fu_64;
        end if; 
    end process;

    i_35_cast_fu_209_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_27),64));
    icmp_ln94_fu_197_p2 <= "1" when (ap_sig_allocacmp_i_27 = ap_const_lv4_8) else "0";
    survival_path_address0 <= zext_ln97_fu_220_p1(4 - 1 downto 0);
    survival_path_address1 <= i_35_cast_fu_209_p1(4 - 1 downto 0);
    ...
    survival_path_d0 <= tmp_40_fu_248_p10;
    survival_path_d1 <= tmp_39_fu_225_p10;
    ...
    xor_ln97_fu_214_p2 <= (ap_sig_allocacmp_i_27 xor ap_const_lv4_8);
