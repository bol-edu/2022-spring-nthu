...
$(ObjDir)/normal_rng.cpp_pre.cpp.tb.o : normal_rng.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling normal_rng.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
...
$(ObjDir)/MIMO.cpp_pre.cpp.tb.o : MIMO.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling MIMO.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/KBEST.cpp_pre.cpp.tb.o : KBEST.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling KBEST.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/DeModulation.cpp_pre.cpp.tb.o : DeModulation.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling DeModulation.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
