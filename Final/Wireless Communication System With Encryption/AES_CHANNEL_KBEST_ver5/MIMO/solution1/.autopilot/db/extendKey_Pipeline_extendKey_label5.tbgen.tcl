set moduleName extendKey_Pipeline_extendKey_label5
set isTopModule 0
...
set C_modelName {extendKey_Pipeline_extendKey_label5}
set C_modelType { void 0 }
set C_modelArgList {
	{ key int 8 regular {array 16 { 1 1 } 1 1 }  }
	{ w int 32 regular {array 44 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	key { ap_memory {  { key_address0 mem_address 1 4 }  { key_ce0 mem_ce 1 1 }  { key_q0 in_data 0 8 }  { key_address1 MemPortADDR2 1 4 }  { key_ce1 MemPortCE2 1 1 }  { key_q1 in_data 0 8 } } }
	w { ap_memory {  { w_address0 mem_address 1 6 }  { w_ce0 mem_ce 1 1 }  { w_we0 mem_we 1 1 }  { w_d0 mem_din 1 32 } } }
}
