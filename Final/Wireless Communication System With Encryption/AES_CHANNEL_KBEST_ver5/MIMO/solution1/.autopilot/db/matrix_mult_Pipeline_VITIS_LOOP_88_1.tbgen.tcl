set moduleName matrix_mult_Pipeline_VITIS_LOOP_88_1
set isTopModule 0
...
set C_modelName {matrix_mult_Pipeline_VITIS_LOOP_88_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ Q_TEMP_V int 16 regular {array 64 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ Q int 16 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "Q_TEMP_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ Q_dout sc_in sc_lv 16 signal 1 } 
	{ Q_empty_n sc_in sc_logic 1 signal 1 } 
	{ Q_read sc_out sc_logic 1 signal 1 } 
	{ Q_TEMP_V_address0 sc_out sc_lv 6 signal 0 } 
	{ Q_TEMP_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ Q_TEMP_V_we0 sc_out sc_logic 1 signal 0 } 
	{ Q_TEMP_V_d0 sc_out sc_lv 16 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Q_TEMP_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "Q_TEMP_V", "role": "we0" }} , 
 	{ "name": "Q_TEMP_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "Q_TEMP_V", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	Q_TEMP_V { ap_memory {  { Q_TEMP_V_address0 mem_address 1 6 }  { Q_TEMP_V_ce0 mem_ce 1 1 }  { Q_TEMP_V_we0 mem_we 1 1 }  { Q_TEMP_V_d0 mem_din 1 16 } } }
