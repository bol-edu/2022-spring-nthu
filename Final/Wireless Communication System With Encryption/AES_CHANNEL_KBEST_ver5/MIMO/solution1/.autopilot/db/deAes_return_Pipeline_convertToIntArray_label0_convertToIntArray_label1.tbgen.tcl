set moduleName deAes_return_Pipeline_convertToIntArray_label0_convertToIntArray_label1
set isTopModule 0
...
set C_modelName {deAes_return_Pipeline_convertToIntArray_label0_convertToIntArray_label1}
set C_modelType { void 0 }
set C_modelArgList {
	{ cArray int 32 regular {array 16 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "cArray", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_165_8_1_1_U1322", "Parent" : "0"},
...
set Spec2ImplPortList { 
	cArray { ap_memory {  { cArray_address0 mem_address 1 4 }  { cArray_ce0 mem_ce 1 1 }  { cArray_we0 mem_we 1 1 }  { cArray_d0 mem_din 1 32 } } }
