set moduleName aes_return_Pipeline_subBytes_label0_subBytes_label7
set isTopModule 0
...
set C_modelName {aes_return_Pipeline_subBytes_label0_subBytes_label7}
set C_modelType { void 0 }
set C_modelArgList {
	{ pArray int 32 regular {array 16 { 0 1 } 1 1 }  }
...
set portList { 
	...
	{ S_address0 sc_out sc_lv 8 signal 1 } 
	{ S_ce0 sc_out sc_logic 1 signal 1 } 
	{ S_q0 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	pArray { ap_memory {  { pArray_address0 mem_address 1 4 }  { pArray_ce0 mem_ce 1 1 }  { pArray_we0 mem_we 1 1 }  { pArray_d0 mem_din 1 32 }  { pArray_address1 MemPortADDR2 1 4 }  { pArray_ce1 MemPortCE2 1 1 }  { pArray_q1 in_data 0 32 } } }
