...
$(warning “here add the debug infoxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx”)
$(info $(TEMP_DIR) )
...
CXXFLAGS +=  -I $(TEMP_DIR)/../src/dsp/L1/examples/myfix4_dataflow_final/src/picture_txt
VPP_FLAGS +=  -I $(TEMP_DIR)/../src/dsp/L1/include/hw/vitis_fft/fixed
VPP_FLAGS +=  -I $(TEMP_DIR)/../src/dsp/HLS_Final_Channel_Model/code/include
VPP_FLAGS +=  -I $(TEMP_DIR)/../src/dsp/HLS_Final_Channel_Model/ext/dcmt/dcmt/include
VPP_FLAGS +=  -I $(TEMP_DIR)/../src/dsp/L1/examples/myfix4_dataflow_final/src/picture_txt/pic_data.txt

$(warning “here add the debug infoxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx”)
$(info $(TEMP_DIR)/../src/dsp/L1/include/hw/vitis_fft/float)
