...
set xo_kernel_name "windex"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/0NTHU/02grade/HLS/final_project/test/solution1"
set debug_dir "D:/0NTHU/02grade/HLS/final_project/test/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {windex_flow_control_loop_pipe_sequential_init
windex_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 recv W 0x0 "Data signal of recv" {{0 32 recv W 0 "Bit 31 to 0 of recv"}}} {0x18 sent W 0x0 "Data signal of sent" {{0 32 sent W 0 "Bit 31 to 0 of sent"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control pout8 word"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
