...
set xo_kernel_name "wgen_mix"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/0NTHU/02grade/HLS/final_project/test/wgen_mix/wgen_mix"
set debug_dir "D:/0NTHU/02grade/HLS/final_project/test/wgen_mix/wgen_mix/.debug"
set xo_hls_files_dir ""
set hdl_module_list {wgen_mix_flow_control_loop_pipe_sequential_init
wgen_mix_flow_control_loop_pipe_sequential_init
wgen_mix_flow_control_loop_pipe_sequential_init
...
wgen_mix_regslice_both
wgen_mix_regslice_both
wgen_mix_Pipeline_VITIS_LOOP_33_2
wgen_mix_Pipeline_VITIS_LOOP_51_3
wgen_mix_Pipeline_VITIS_LOOP_60_4
wgen_mix
}
set kernel_xo ""
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_EN RW 0 {Enable Channel 2 (ap_local_deadlock) Interrupt.  0 = Disabled, 1 = Enabled.}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_ST RTOW 0 {Channel 2 (ap_local_deadlock) Interrupt Status. 0 = No Channel 2 input interrupt, 1 = Channel 2 input interrup}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x10 rows W 0x0 "Data signal of rows" {{0 32 rows W 0 "Bit 31 to 0 of rows"}}} {0x18 cols W 0x0 "Data signal of cols" {{0 32 cols W 0 "Bit 31 to 0 of cols"}}} {0x20 wrecv R 0x0 "Data signal of wrecv" {{0 32 wrecv R 0 "Bit 31 to 0 of wrecv"}}} {0x24 wrecv_ctrl R 0x0 "Control signal of wrecv" {{0 1 wrecv_ap_vld R 0 "Control signal wrecv_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 isent R 0x0 "Data signal of isent" {{0 32 isent R 0 "Bit 31 to 0 of isent"}}} {0x34 isent_ctrl R 0x0 "Control signal of isent" {{0 1 isent_ap_vld R 0 "Control signal isent_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control src dst word"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
