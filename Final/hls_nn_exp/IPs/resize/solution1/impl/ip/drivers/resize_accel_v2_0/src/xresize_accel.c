...
void XResize_accel_Set_src_rows(XResize_accel *InstancePtr, u32 Data) {
    ...
    XResize_accel_WriteReg(InstancePtr->Control_BaseAddress, XRESIZE_ACCEL_CONTROL_ADDR_SRC_ROWS_DATA, Data);
}
...
u32 XResize_accel_Get_src_rows(XResize_accel *InstancePtr) {
    ...
    Data = XResize_accel_ReadReg(InstancePtr->Control_BaseAddress, XRESIZE_ACCEL_CONTROL_ADDR_SRC_ROWS_DATA);
    return Data;
}
...
void XResize_accel_Set_src_cols(XResize_accel *InstancePtr, u32 Data) {
    ...
    XResize_accel_WriteReg(InstancePtr->Control_BaseAddress, XRESIZE_ACCEL_CONTROL_ADDR_SRC_COLS_DATA, Data);
}
...
u32 XResize_accel_Get_src_cols(XResize_accel *InstancePtr) {
    ...
    Data = XResize_accel_ReadReg(InstancePtr->Control_BaseAddress, XRESIZE_ACCEL_CONTROL_ADDR_SRC_COLS_DATA);
    return Data;
}
...
void XResize_accel_Set_dst_rows(XResize_accel *InstancePtr, u32 Data) {
    ...
    XResize_accel_WriteReg(InstancePtr->Control_BaseAddress, XRESIZE_ACCEL_CONTROL_ADDR_DST_ROWS_DATA, Data);
}
...
u32 XResize_accel_Get_dst_rows(XResize_accel *InstancePtr) {
    ...
    Data = XResize_accel_ReadReg(InstancePtr->Control_BaseAddress, XRESIZE_ACCEL_CONTROL_ADDR_DST_ROWS_DATA);
    return Data;
}
...
void XResize_accel_Set_dst_cols(XResize_accel *InstancePtr, u32 Data) {
    ...
    XResize_accel_WriteReg(InstancePtr->Control_BaseAddress, XRESIZE_ACCEL_CONTROL_ADDR_DST_COLS_DATA, Data);
}
...
u32 XResize_accel_Get_dst_cols(XResize_accel *InstancePtr) {
    ...
    Data = XResize_accel_ReadReg(InstancePtr->Control_BaseAddress, XRESIZE_ACCEL_CONTROL_ADDR_DST_COLS_DATA);
    return Data;
}
