...
set Library     "hls"
set IPName      "stream8rto8"
set Version     "2.0"
set DisplayName "Stream8rto8"
set Revision    "1"
...
set xo_kernel_name "stream8rto8"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/0NTHU/02grade/HLS/final_project/test/src/stream8rto8/solution1"
set debug_dir "D:/0NTHU/02grade/HLS/final_project/test/src/stream8rto8/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {stream8rto8_control_s_axi
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 recv R 0x0 "Data signal of recv" {{0 32 recv R 0 "Bit 31 to 0 of recv"}}} {0x14 recv_ctrl R 0x0 "Control signal of recv" {{0 1 recv_ap_vld R 0 "Control signal recv_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 send R 0x0 "Data signal of send" {{0 32 send R 0 "Bit 31 to 0 of send"}}} {0x24 send_ctrl R 0x0 "Control signal of send" {{0 1 send_ap_vld R 0 "Control signal send_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control pin8 pout8"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
