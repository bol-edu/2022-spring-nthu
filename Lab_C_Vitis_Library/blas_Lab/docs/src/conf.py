...
#The extension 'edit_on_github' is not working with autoclass
...
latex_documents = [
    (master_doc, 'xf_blas.tex', 'Vitis BLAS Library Documentation',
     'Xilinx', 'manual'),
]
...
man_pages = [
    (master_doc, 'xf_blas', 'Vitis BLAS Library Documentation',
     [author], 1)
]
