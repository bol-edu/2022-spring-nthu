...
(* CORE_GENERATION_INFO="dct,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-1-e,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.351000,HLS_SYN_LAT=843,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=8,HLS_SYN_FF=520,HLS_SYN_LUT=1483}" *)
...
reg   [3:0] ap_phi_mux_r_i_phi_fu_149_p4;
wire    ap_block_pp0_stage0;
reg   [3:0] ap_phi_mux_r_i2_phi_fu_182_p4;
wire    ap_block_pp1_stage0;
reg    ap_reg_grp_dct_2d_fu_200_ap_start;
wire    ap_CS_fsm_state4;
wire   [63:0] tmp_i_fu_284_p1;
wire   [63:0] tmp_41_cast_fu_315_p1;
wire   [63:0] tmp_45_cast_fu_398_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b1 == ap_condition_pp1_exit_iter0_state6) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state5) & (grp_dct_2d_fu_200_ap_done == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        end else if ((grp_dct_2d_fu_200_ap_ready == 1'b1)) begin
            ap_reg_grp_dct_2d_fu_200_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten2_fu_320_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_222_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten2_reg_449 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_reg_419 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_flatten_fu_222_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (exitcond_flatten2_fu_320_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((exitcond_flatten2_fu_320_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_flatten2_reg_449 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1))) begin
        ap_phi_mux_r_i2_phi_fu_182_p4 = tmp_i4_mid2_v_reg_458;
    end else begin
        ap_phi_mux_r_i2_phi_fu_182_p4 = r_i2_reg_178;
    end
end

always @ (*) begin
    if (((exitcond_flatten_reg_419 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_phi_mux_r_i_phi_fu_149_p4 = tmp_i_mid2_v_v_reg_433;
    end else begin
        ap_phi_mux_r_i_phi_fu_149_p4 = r_i_reg_145;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        buf_2d_in_address0 = tmp_41_cast_fu_315_p1;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        buf_2d_out_address0 = tmp_45_cast_fu_398_p1;
    end else if ((1'b1 == ap_CS_fsm_state5)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((exitcond_flatten_fu_222_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((exitcond_flatten_fu_222_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
        ...
        ap_ST_fsm_state5 : begin
            if (((1'b1 == ap_CS_fsm_state5) & (grp_dct_2d_fu_200_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((exitcond_flatten2_fu_320_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((exitcond_flatten2_fu_320_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
...
assign c_1_fu_409_p2 = (4'd1 + c_i6_mid2_fu_344_p3);

assign c_fu_289_p2 = (4'd1 + c_i_mid2_fu_246_p3);

assign c_i6_cast2_fu_384_p1 = c_i6_mid2_fu_344_p3;

assign c_i6_mid2_fu_344_p3 = ((exitcond_i1_fu_338_p2[0:0] === 1'b1) ? 4'd0 : c_i6_reg_189);

assign c_i_cast6_fu_274_p1 = c_i_mid2_fu_246_p3;

assign c_i_mid2_fu_246_p3 = ((exitcond_i_fu_240_p2[0:0] === 1'b1) ? 4'd0 : c_i_reg_156);

assign exitcond_flatten2_fu_320_p2 = ((indvar_flatten2_reg_167 == 7'd64) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_222_p2 = ((indvar_flatten_reg_134 == 7'd64) ? 1'b1 : 1'b0);

assign exitcond_i1_fu_338_p2 = ((c_i6_reg_189 == 4'd8) ? 1'b1 : 1'b0);

assign exitcond_i_fu_240_p2 = ((c_i_reg_156 == 4'd8) ? 1'b1 : 1'b0);

assign grp_dct_2d_fu_200_ap_start = ap_reg_grp_dct_2d_fu_200_ap_start;

assign indvar_flatten_next2_fu_326_p2 = (indvar_flatten2_reg_167 + 7'd1);
...
assign r_1_fu_332_p2 = (4'd1 + ap_phi_mux_r_i2_phi_fu_182_p4);

assign r_fu_234_p2 = (4'd1 + ap_phi_mux_r_i_phi_fu_149_p4);

assign tmp_1_fu_372_p1 = tmp_i4_mid2_v_fu_352_p3[2:0];

assign tmp_1_i5_mid2_fu_376_p3 = {{tmp_1_fu_372_p1}, {3'd0}};

assign tmp_1_i_cast_fu_306_p1 = c_i_mid2_reg_428;

assign tmp_33_fu_309_p2 = (tmp_40_cast_fu_302_p1 + tmp_1_i_cast_fu_306_p1);

assign tmp_34_fu_360_p3 = {{tmp_i4_mid2_v_fu_352_p3}, {3'd0}};

assign tmp_35_fu_392_p2 = (tmp_43_cast_fu_368_p1 + tmp_3_i_cast_fu_388_p1);

assign tmp_3_i_cast_fu_388_p1 = c_i6_mid2_fu_344_p3;

assign tmp_40_cast_fu_302_p1 = tmp_s_fu_295_p3;

assign tmp_41_cast_fu_315_p1 = tmp_33_fu_309_p2;

assign tmp_43_cast_fu_368_p1 = tmp_34_fu_360_p3;

assign tmp_45_cast_fu_398_p1 = tmp_35_fu_392_p2;
...
assign tmp_i4_mid2_v_fu_352_p3 = ((exitcond_i1_fu_338_p2[0:0] === 1'b1) ? r_1_fu_332_p2 : ap_phi_mux_r_i2_phi_fu_182_p4);

assign tmp_i_fu_284_p1 = tmp_9_i_fu_278_p2;

assign tmp_i_mid2_fu_266_p3 = {{tmp_fu_262_p1}, {3'd0}};

assign tmp_i_mid2_v_v_fu_254_p3 = ((exitcond_i_fu_240_p2[0:0] === 1'b1) ? r_fu_234_p2 : ap_phi_mux_r_i_phi_fu_149_p4);

assign tmp_s_fu_295_p3 = {{tmp_i_mid2_v_v_reg_433}, {3'd0}};
