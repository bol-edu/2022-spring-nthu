...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("a_address1", 4, hls_out, 0, "ap_memory", "MemPortADDR2", 1),
	Port_Property("a_ce1", 1, hls_out, 0, "ap_memory", "MemPortCE2", 1),
	Port_Property("a_q1", 8, hls_in, 0, "ap_memory", "MemPortDOUT2", 1),
	...
	Port_Property("b_address1", 4, hls_out, 1, "ap_memory", "MemPortADDR2", 1),
	Port_Property("b_ce1", 1, hls_out, 1, "ap_memory", "MemPortCE2", 1),
	Port_Property("b_q1", 8, hls_in, 1, "ap_memory", "MemPortDOUT2", 1),
