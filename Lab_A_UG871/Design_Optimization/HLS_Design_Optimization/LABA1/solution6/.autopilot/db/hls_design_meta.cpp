...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("b_address1", 2, hls_out, 1, "ap_memory", "MemPortADDR2", 1),
	Port_Property("b_ce1", 1, hls_out, 1, "ap_memory", "MemPortCE2", 1),
	Port_Property("b_q1", 24, hls_in, 1, "ap_memory", "in_data", 1),
	...
	Port_Property("res_address1", 4, hls_out, 2, "ap_memory", "MemPortADDR2", 1),
	Port_Property("res_ce1", 1, hls_out, 2, "ap_memory", "MemPortCE2", 1),
	Port_Property("res_we1", 1, hls_out, 2, "ap_memory", "MemPortWE2", 1),
	Port_Property("res_d1", 16, hls_out, 2, "ap_memory", "MemPortDIN2", 1),
};
