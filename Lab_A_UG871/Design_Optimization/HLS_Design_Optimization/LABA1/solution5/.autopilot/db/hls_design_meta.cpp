...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("b_dout", 24, hls_in, 1, "ap_fifo", "fifo_data", 9),
	Port_Property("b_empty_n", 1, hls_in, 1, "ap_fifo", "fifo_status", 9),
	Port_Property("b_read", 1, hls_out, 1, "ap_fifo", "fifo_update", 9),
