...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "aaa.autotvin.dat"
	set constFileTvOut       "aaa.autotvout.dat"
	set constFileHdlTvIn     "aaa.autohdltvin.dat"
	set constFileHdlTvOut    "aaa.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
