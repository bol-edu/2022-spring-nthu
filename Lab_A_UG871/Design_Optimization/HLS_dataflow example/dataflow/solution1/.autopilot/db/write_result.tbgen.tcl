...
set C_modelArgList {
	...
	{ outStream int 32 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "outStream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ size_dout sc_in sc_lv 32 signal 2 } 
	{ size_empty_n sc_in sc_logic 1 signal 2 } 
	{ size_read sc_out sc_logic 1 signal 2 } 
	{ outStream_dout sc_in sc_lv 32 signal 3 } 
	{ outStream_empty_n sc_in sc_logic 1 signal 3 } 
	{ outStream_read sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outStream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "outStream", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "outStream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "4104"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "4104"}
]}
...
set Spec2ImplPortList { 
	...
	outStream { ap_fifo {  { outStream_dout fifo_data 0 32 }  { outStream_empty_n fifo_status 0 1 }  { outStream_read fifo_update 1 1 } } }
}
