...
set C_modelArgList {
	...
	{ inc_out int 32 regular {fifo 1}  }
	{ inStream int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "inc", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "size_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "out_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "inc_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "inStream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ inc sc_in sc_lv 32 signal 4 } 
	{ size_out_din sc_out sc_lv 32 signal 5 } 
	{ size_out_full_n sc_in sc_logic 1 signal 5 } 
	{ size_out_write sc_out sc_logic 1 signal 5 } 
	{ out_out_din sc_out sc_lv 64 signal 6 } 
	{ out_out_full_n sc_in sc_logic 1 signal 6 } 
	{ out_out_write sc_out sc_logic 1 signal 6 } 
	{ inc_out_din sc_out sc_lv 32 signal 7 } 
	{ inc_out_full_n sc_in sc_logic 1 signal 7 } 
	{ inc_out_write sc_out sc_logic 1 signal 7 } 
	{ inStream_din sc_out sc_lv 32 signal 8 } 
	{ inStream_full_n sc_in sc_logic 1 signal 8 } 
	{ inStream_write sc_out sc_logic 1 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inc", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "inc", "role": "default" }} , 
 	...
 	{ "name": "inc_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "inc_out", "role": "din" }} , 
 	{ "name": "inc_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inc_out", "role": "full_n" }} , 
 	{ "name": "inc_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "inc_out", "role": "write" }} , 
 	{ "name": "inStream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "inStream", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "out_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "inc_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "inc_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "inStream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "4106"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "4106"}
]}
...
set Spec2ImplPortList { 
	...
	inc_out { ap_fifo {  { inc_out_din fifo_data 1 32 }  { inc_out_full_n fifo_status 0 1 }  { inc_out_write fifo_update 1 1 } } }
	inStream { ap_fifo {  { inStream_din fifo_data 1 32 }  { inStream_full_n fifo_status 0 1 }  { inStream_write fifo_update 1 1 } } }
}
