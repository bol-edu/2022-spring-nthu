...
architecture behav of axi_interfaces is 
    ...
    "axi_interfaces_axi_interfaces,hls_ip_2021_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.602000,HLS_SYN_LAT=4,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=570,HLS_SYN_LUT=881,HLS_VERSION=2021_2}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_reg_791 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                do_init_reg_204 <= ap_const_lv1_0;
            elsif ((((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_reg_791 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_start = ap_const_logic_1) and (tmp_fu_648_p3 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    begin
                ap_block_pp0_stage0_11001 <= (((ap_start = ap_const_logic_1) and ((d_i_7_TVALID_int_regslice = ap_const_logic_0) or (d_i_6_TVALID_int_regslice = ap_const_logic_0) or (d_i_5_TVALID_int_regslice = ap_const_logic_0) or (d_i_4_TVALID_int_regslice = ap_const_logic_0) or (d_i_3_TVALID_int_regslice = ap_const_logic_0) or (d_i_2_TVALID_int_regslice = ap_const_logic_0) or (d_i_1_TVALID_int_regslice = ap_const_logic_0) or (d_i_0_TVALID_int_regslice = ap_const_logic_0) or (d_o_7_TREADY_int_regslice = ap_const_logic_0) or (d_o_6_TREADY_int_regslice = ap_const_logic_0) or (d_o_5_TREADY_int_regslice = ap_const_logic_0) or (d_o_4_TREADY_int_regslice = ap_const_logic_0) or (d_o_3_TREADY_int_regslice = ap_const_logic_0) or (d_o_2_TREADY_int_regslice = ap_const_logic_0) or (d_o_1_TREADY_int_regslice = ap_const_logic_0) or (d_o_0_TREADY_int_regslice = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state2_io))) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and ((regslice_both_d_o_1_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_0_U_apdone_blk = ap_const_logic_1) or (d_o_7_TREADY_int_regslice = ap_const_logic_0) or (d_o_6_TREADY_int_regslice = ap_const_logic_0) or (d_o_5_TREADY_int_regslice = ap_const_logic_0) or (d_o_4_TREADY_int_regslice = ap_const_logic_0) or (d_o_3_TREADY_int_regslice = ap_const_logic_0) or (d_o_2_TREADY_int_regslice = ap_const_logic_0) or (d_o_1_TREADY_int_regslice = ap_const_logic_0) or (d_o_0_TREADY_int_regslice = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state3_io) or (regslice_both_d_o_7_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_6_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_5_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_4_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_3_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_2_U_apdone_blk = ap_const_logic_1))));
    end process;
    ...
    begin
                ap_block_state3_pp0_stage0_iter1 <= ((regslice_both_d_o_1_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_0_U_apdone_blk = ap_const_logic_1) or (d_o_7_TREADY_int_regslice = ap_const_logic_0) or (d_o_6_TREADY_int_regslice = ap_const_logic_0) or (d_o_5_TREADY_int_regslice = ap_const_logic_0) or (d_o_4_TREADY_int_regslice = ap_const_logic_0) or (d_o_3_TREADY_int_regslice = ap_const_logic_0) or (d_o_2_TREADY_int_regslice = ap_const_logic_0) or (d_o_1_TREADY_int_regslice = ap_const_logic_0) or (d_o_0_TREADY_int_regslice = ap_const_logic_0) or (regslice_both_d_o_7_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_6_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_5_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_4_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_3_U_apdone_blk = ap_const_logic_1) or (regslice_both_d_o_2_U_apdone_blk = ap_const_logic_1));
    end process;


    ap_condition_181_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
                ap_condition_181 <= ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, tmp_reg_791)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_reg_791 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    ap_phi_mux_do_init_phi_fu_208_p6_assign_proc : process(do_init_reg_204, tmp_reg_791, ap_condition_181)
    begin
    ...
    ap_phi_mux_i1_phi_fu_336_p6_assign_proc : process(i1_reg_332, trunc_ln64_reg_786, tmp_reg_791, ap_condition_181)
    begin
        if ((ap_const_boolean_1 = ap_condition_181)) then
            if ((tmp_reg_791 = ap_const_lv1_1)) then 
    ...
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_start = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_start = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0)) or ((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)))) then 
