      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "d_i_0");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "d_i_1");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "d_i_2");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "d_i_3");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "d_i_4");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "d_i_5");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "d_i_6");
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "d_i_7");
...
aesl_fh.write(AUTOTB_TVIN_d_i_2, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_2) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_2)[j];
...
aesl_fh.write(AUTOTB_TVIN_d_i_3, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_3) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_3)[j];
...
aesl_fh.write(AUTOTB_TVIN_d_i_4, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_4) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_4)[j];
...
aesl_fh.write(AUTOTB_TVIN_d_i_5, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_5) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_5)[j];
...
aesl_fh.write(AUTOTB_TVIN_d_i_6, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_6) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_6)[j];
...
aesl_fh.write(AUTOTB_TVIN_d_i_7, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_7) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_7)[j];
...
aesl_fh.write(AUTOTB_TVOUT_d_i_0, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_0) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_0)[j];
aesl_fh.write(AUTOTB_TVOUT_d_i_0, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
...
aesl_fh.write(AUTOTB_TVOUT_d_i_1, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_1) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_1)[j];
aesl_fh.write(AUTOTB_TVOUT_d_i_1, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
...
aesl_fh.write(AUTOTB_TVOUT_d_i_2, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_2) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_2)[j];
aesl_fh.write(AUTOTB_TVOUT_d_i_2, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
...
aesl_fh.write(AUTOTB_TVOUT_d_i_3, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_3) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_3)[j];
aesl_fh.write(AUTOTB_TVOUT_d_i_3, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
...
aesl_fh.write(AUTOTB_TVOUT_d_i_4, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_4) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_4)[j];
aesl_fh.write(AUTOTB_TVOUT_d_i_4, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
...
aesl_fh.write(AUTOTB_TVOUT_d_i_5, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_5) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_5)[j];
aesl_fh.write(AUTOTB_TVOUT_d_i_5, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
...
aesl_fh.write(AUTOTB_TVOUT_d_i_6, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_6) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_6)[j];
aesl_fh.write(AUTOTB_TVOUT_d_i_6, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
...
aesl_fh.write(AUTOTB_TVOUT_d_i_7, begin_str(AESL_transaction));
  if (__xlx_apatb_param_d_i_7) {
    for (int j = 0  - 0, e = 4 - 0; j != e; ++j) {
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_d_i_7)[j];
aesl_fh.write(AUTOTB_TVOUT_d_i_7, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
    }
  }
