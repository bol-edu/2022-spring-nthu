; ModuleID = 'D:/lab_A/Interface_Synthesis/lab4/axi_interfaces_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_axi_interfaces_ir(i16* %d_o, i16* %d_i) local_unnamed_addr #1 {
entry:
  ...
  call void @copy_in([32 x i16]* %0, [4 x i16]* nonnull align 512 %d_o_copy_0, [4 x i16]* nonnull align 512 %d_o_copy_1, [4 x i16]* nonnull align 512 %d_o_copy_2, [4 x i16]* nonnull align 512 %d_o_copy_3, [4 x i16]* nonnull align 512 %d_o_copy_4, [4 x i16]* nonnull align 512 %d_o_copy_5, [4 x i16]* nonnull align 512 %d_o_copy_6, [4 x i16]* nonnull align 512 %d_o_copy_7, [32 x i16]* %1, [4 x i16]* nonnull align 512 %d_i_copy_0, [4 x i16]* nonnull align 512 %d_i_copy_1, [4 x i16]* nonnull align 512 %d_i_copy_2, [4 x i16]* nonnull align 512 %d_i_copy_3, [4 x i16]* nonnull align 512 %d_i_copy_4, [4 x i16]* nonnull align 512 %d_i_copy_5, [4 x i16]* nonnull align 512 %d_i_copy_6, [4 x i16]* nonnull align 512 %d_i_copy_7)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i16* %d_i_copy.gep_2, i32 0, i32 1, i32 0, i1 false) ], !dbg !26
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i16* %d_i_copy.gep_3, i32 0, i32 1, i32 0, i1 false) ], !dbg !26
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i16* %d_i_copy.gep_4, i32 0, i32 1, i32 0, i1 false) ], !dbg !26
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i16* %d_i_copy.gep_5, i32 0, i32 1, i32 0, i1 false) ], !dbg !26
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i16* %d_i_copy.gep_6, i32 0, i32 1, i32 0, i1 false) ], !dbg !26
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i16* %d_i_copy.gep_7, i32 0, i32 1, i32 0, i1 false) ], !dbg !26
  ...
  call void @copy_out([32 x i16]* %0, [4 x i16]* nonnull align 512 %d_o_copy_0, [4 x i16]* nonnull align 512 %d_o_copy_1, [4 x i16]* nonnull align 512 %d_o_copy_2, [4 x i16]* nonnull align 512 %d_o_copy_3, [4 x i16]* nonnull align 512 %d_o_copy_4, [4 x i16]* nonnull align 512 %d_o_copy_5, [4 x i16]* nonnull align 512 %d_o_copy_6, [4 x i16]* nonnull align 512 %d_o_copy_7, [32 x i16]* %1, [4 x i16]* nonnull align 512 %d_i_copy_0, [4 x i16]* nonnull align 512 %d_i_copy_1, [4 x i16]* nonnull align 512 %d_i_copy_2, [4 x i16]* nonnull align 512 %d_i_copy_3, [4 x i16]* nonnull align 512 %d_i_copy_4, [4 x i16]* nonnull align 512 %d_i_copy_5, [4 x i16]* nonnull align 512 %d_i_copy_6, [4 x i16]* nonnull align 512 %d_i_copy_7)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([32 x i16]* readonly "orig.arg.no"="0", [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_4, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_5, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_6, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_7, [32 x i16]* readonly "orig.arg.no"="2", [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_23, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_34, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_45, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_56, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_67, [4 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_78) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([32 x i16]* "orig.arg.no"="0", [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_4, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_5, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_6, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_7, [32 x i16]* "orig.arg.no"="2", [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_23, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_34, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_45, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_56, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_67, [4 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_78) #4 {
entry:
...
!6 = distinct !DISubprogram(name: "axi_interfaces", scope: !7, file: !7, line: 57, type: !8, isLocal: false, isDefinition: true, scopeLine: 57, flags: DIFlagPrototyped, isOptimized: false, unit: !16, variables: !4)
!7 = !DIFile(filename: "axi_interfaces.c", directory: "D:\5Clab_A\5CInterface_Synthesis\5Clab4")
!8 = !DISubroutineType(types: !9)
!9 = !{null, !10, !14}
!10 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 64)
!11 = !DIDerivedType(tag: DW_TAG_typedef, name: "dout_t", file: !12, line: 52, baseType: !13)
!12 = !DIFile(filename: "./axi_interfaces.h", directory: "D:\5Clab_A\5CInterface_Synthesis\5Clab4")
...
!17 = !DIFile(filename: "D:/lab_A/Interface_Synthesis/lab4/axi_interfaces_prj/solution1/.autopilot/db\5Caxi_interfaces.pp.0.c", directory: "D:\5Clab_A\5CInterface_Synthesis\5Clab4")
!18 = !{!19}
...
!26 = !DILocation(line: 57, column: 141, scope: !6)
