...
signed int adders(signed int , signed int , signed int );
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 @adders(i32 10, i32 20, i32 30) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_17_count);
  llvm_cbe_tmp__1 = (unsigned int ) /*tail*/ adders(10u, 20u, 30u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",10u);
printf("\nArgument  = 0x%X",20u);
printf("\nArgument  = 0x%X",30u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = tail call i32 @adders(i32 20, i32 30, i32 40) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_41_count);
  llvm_cbe_tmp__5 = (unsigned int ) /*tail*/ adders(20u, 30u, 40u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",20u);
printf("\nArgument  = 0x%X",30u);
printf("\nArgument  = 0x%X",40u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = tail call i32 @adders(i32 30, i32 40, i32 50) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_65_count);
  llvm_cbe_tmp__9 = (unsigned int ) /*tail*/ adders(30u, 40u, 50u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",30u);
printf("\nArgument  = 0x%X",40u);
printf("\nArgument  = 0x%X",50u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = tail call i32 @adders(i32 40, i32 50, i32 60) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_89_count);
  llvm_cbe_tmp__13 = (unsigned int ) /*tail*/ adders(40u, 50u, 60u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",40u);
printf("\nArgument  = 0x%X",50u);
printf("\nArgument  = 0x%X",60u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = tail call i32 @adders(i32 50, i32 60, i32 70) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_113_count);
  llvm_cbe_tmp__17 = (unsigned int ) /*tail*/ adders(50u, 60u, 70u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",50u);
printf("\nArgument  = 0x%X",60u);
printf("\nArgument  = 0x%X",70u);
