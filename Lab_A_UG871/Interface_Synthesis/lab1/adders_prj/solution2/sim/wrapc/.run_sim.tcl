...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "adders.autotvin.dat"
	set constFileTvOut       "adders.autotvout.dat"
	set constFileHdlTvIn     "adders.autohdltvin.dat"
	set constFileHdlTvOut    "adders.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
