...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "adders_io.autotvin.dat"
	set constFileTvOut       "adders_io.autotvout.dat"
	set constFileHdlTvIn     "adders_io.autohdltvin.dat"
	set constFileHdlTvOut    "adders_io.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
