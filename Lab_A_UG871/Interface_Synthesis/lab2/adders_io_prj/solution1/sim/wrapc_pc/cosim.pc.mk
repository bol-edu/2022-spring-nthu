...
$(ObjDir)/adders_io_test.c_pre.c.tb.o : adders_io_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) adders_io_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/adders_io.c_pre.c.tb.o : adders_io.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) adders_io.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
