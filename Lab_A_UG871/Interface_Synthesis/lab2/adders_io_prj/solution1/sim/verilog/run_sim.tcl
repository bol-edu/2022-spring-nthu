...
if {[file isfile adders_io.autotvin.dat]} {
	file delete -force adders_io.autotvin.dat
}

if {[file isfile adders_io.autotvout.dat]} {
	file delete -force adders_io.autotvout.dat
}
