...
architecture behav of adders_io is 
    ...
    "adders_io_adders_io,hls_ip_2021_2,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.907000,HLS_SYN_LAT=2,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=36,HLS_SYN_LUT=144,HLS_VERSION=2021_2}";
    ...
    signal add_ln50_fu_57_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((regslice_forward_in_out1_o_U_apdone_blk = ap_const_logic_1) or (in_out1_o_ap_ack_int_regslice = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                    in1_ap_vld_preg <= ap_const_logic_0;
                elsif ((not(((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_0))) and (in1_ap_vld = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not(((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_0))) and (in1_ap_vld = ap_const_logic_1))) then 
                    in1_preg <= in1;
                end if; 
            end if;
        end if;
    ...
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((in1_ap_vld_in_sig = ap_const_logic_0) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    add_ln50_fu_57_p2 <= std_logic_vector(unsigned(in2) + unsigned(in1_in_sig));
    ...
    begin
        if (((in1_ap_vld_in_sig = ap_const_logic_0) or (ap_start = ap_const_logic_0))) then 
    ...
    begin
                ap_block_state1 <= ((in1_ap_vld_in_sig = ap_const_logic_0) or (ap_start = ap_const_logic_0));
    end process;
    ...
    in_out1_o_int_regslice <= std_logic_vector(unsigned(add_ln50_fu_57_p2) + unsigned(in_out1_i_int_regslice));
end behav;
