...
# 1 "./adders_io.h" 1
# 49 "./adders_io.h"
__attribute__((sdx_kernel("adders_io", 0))) void adders_io(int in1, int in2, int *in_out1);
# 47 "adders_io.c" 2

__attribute__((sdx_kernel("adders_io", 0))) void adders_io(int in1, int in2, int *in_out1) {
#pragma HLSDIRECTIVE INTERFACE ap_ack port=in2
# 48 "adders_io.c"

#pragma HLSDIRECTIVE INTERFACE ap_hs port=in_out1
# 48 "adders_io.c"

#pragma HLSDIRECTIVE INTERFACE ap_vld port=in1
# 48 "adders_io.c"

#pragma HLSDIRECTIVE TOP name=adders_io
# 48 "adders_io.c"
