...
void adders_io(signed int , signed int , signed int *);
...
printf("\n = 0x%X\n", 30u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 10, i32 20, i32* %%ioC) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_27_count);
  adders_io(10u, 20u, (signed int *)(&llvm_cbe_ioC));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",10u);
printf("\nArgument  = 0x%X",20u);
}
...
printf("\n = 0x%X\n", 40u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 20, i32 30, i32* %%ioC) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_67_count);
  adders_io(20u, 30u, (signed int *)(&llvm_cbe_ioC));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",20u);
printf("\nArgument  = 0x%X",30u);
}
...
printf("\n = 0x%X\n", 50u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 30, i32 40, i32* %%ioC) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_107_count);
  adders_io(30u, 40u, (signed int *)(&llvm_cbe_ioC));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",30u);
printf("\nArgument  = 0x%X",40u);
}
...
printf("\n = 0x%X\n", 60u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 40, i32 50, i32* %%ioC) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_147_count);
  adders_io(40u, 50u, (signed int *)(&llvm_cbe_ioC));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",40u);
printf("\nArgument  = 0x%X",50u);
}
...
printf("\n = 0x%X\n", 70u);
if (AESL_DEBUG_TRACE)
printf("\n  call void @adders_io(i32 50, i32 60, i32* %%ioC) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_187_count);
  adders_io(50u, 60u, (signed int *)(&llvm_cbe_ioC));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",50u);
printf("\nArgument  = 0x%X",60u);
}
